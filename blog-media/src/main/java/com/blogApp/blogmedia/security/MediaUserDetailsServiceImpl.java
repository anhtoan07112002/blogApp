...
/**
 * Implementation của MediaUserDetailsService
...
public class MediaUserDetailsServiceImpl implements MediaUserDetailsService {
    ...
    public UserDetails loadUserByUsername(String usernameOrEmail) throws UsernameNotFoundException {
        try {
            ...
            // Không có endpoint trực tiếp nên dùng getCurrentUser
